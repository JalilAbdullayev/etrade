...
<section class="axil-poster">
    <div class="container">
        <div class="row">
            <div class="col-lg-6 mb--30">
                <div class="single-poster">
                    <a href="shop.html">
                        <img src="front/images/product/poster/poster-01.png" alt="eTrade promotion poster">
            ...
            <div class="col-lg-6 mb--30">
                <div class="single-poster">
                    <a href="shop-sidebar.html">
                        <img src="front/images/product/poster/poster-02.png" alt="eTrade promotion poster">
