                ...
                <div class="content-block">
                    <div class="inner">
                        <div class="post-thumbnail">
                            <img src="front/images/blog/blog-single.jpg" alt="blog Images">
                        </div>
                        <!-- End .thumbnail -->
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7 axil-post-wrapper">
                        <div class="post-heading">
                            <h2 class="title">How to generate blog ideas are great for businesses that sell both B2B and
                                D2C.</h2>
                            <div class="axil-post-meta">
                                <div class="post-author-avatar">
                                    <img src="front/images/blog/author-image-1.png" alt="Author Images">
                                </div>
                            ...
                            <ul class="comment-list">
                                    ...
                                    <div class="comment-body">
                                        <div class="single-comment">
                                            <div class="comment-img">
                                                <img src="front/images/blog/author-image-4.png" alt="Author Images">
                                            </div>
                                                ...
                                                <h6 class="commenter">
                                                    <a class="hover-flip-item-wrapper" href="#">
                                                            <span class="hover-flip-item">
                                                                <span
                                                                    data-text="Cameron Williamson">Cameron Williamson</span>
                                                            </span>
                                                    </a>
                                                </h6>
                                    ...
                                    <ul class="children">
                                        ...
                                        <li class="comment">
                                            <div class="comment-body">
                                                <div class="single-comment">
                                                    <div class="comment-img">
                                                        <img src="front/images/blog/author-image-4.png"
                                                             alt="Author Images">
                                                    </div>
                                                    <div class="comment-inner">
                                                        <h6 class="commenter">
                                ...
                                <li class="comment">
                                    <div class="comment-body">
                                        <div class="single-comment">
                                            <div class="comment-img">
                                                <img src="front/images/blog/author-image-5.png" alt="Author Images">
                                            </div>
                                            <div class="comment-inner">
                                                <h6 class="commenter">
                                                    <a class="hover-flip-item-wrapper" href="#">
                            ...
                            <div class="axil-gallery-activation axil-slick-arrow arrow-between-side">
                                ...
                                <div class="thumbnail">
                                    <a href="{{ route('article') }}" wire:navigate>
                                        <img src="front/images/blog/blog-07.png" alt="Blog Images">
                                    </a>
                                </div>
                                <!-- End Single Thumb  -->
                            </div>
                            <div class="content">
                                <h5 class="title"><a href="{{ route('article') }}" wire:navigate>With an Irreverent
                                        Twist, AMBUSH®
