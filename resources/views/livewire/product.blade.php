                                    ...
                                    <div class="single-product-thumbnail product-large-thumbnail-3 axil-product">
                                        <div class="thumbnail">
                                            <a href="front/images/product/product-big-01.png" class="popup-zoom">
                                                <img src="front/images/product/product-big-01.png"
                                                     alt="Product Images"/>
                                            </a>
                                        </div>
                                    </div>
                            ...
                            <div class="col-lg-2 order-lg-1">
                                <div class="product-small-thumb-3 small-thumb-wrapper">
                                    <div class="small-thumb-img">
                                        <img src="front/images/product/product-thumb/thumb-08.png" alt="thumb image">
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-lg-12">
                                    <ul class="pro-des-features">
                                        <li class="single-features">
                                            <div class="icon">
                                                <img src="front/images/product/product-thumb/icon-3.png" alt="icon">
                                            </div>
                                            Easy Returns
                                        </li>
                                    </ul>
                ...
                <div class="slick-single-layout">
                    <div class="axil-product">
                        ...
                        <div class="product-content">
                            <div class="inner">
                                <h5 class="title"><a href="{{ route('product') }}" wire:navigate>3D™ wireless
                                        headset</a></h5>
